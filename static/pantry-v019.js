/* Diet Pro Planner v0.0.21-dev · editable pantry + coach actions */
(function () {
  'use strict';
  ...
  function renderPantry() {
    ...
    document.querySelector('#view').innerHTML = `
      <section class="pantry-hero">
        <div><span class="pantry-kicker">COACH LOCAL · v0.0.21-dev</span><h2>Tu despensa real</h2><p>Marca lo que tienes ahora. El Coach solo propondrá comidas con alimentos disponibles.</p></div>
  ...
  try {
    ...
    console.warn('Pantry v0.0.21-dev render wrapper', error);
  }
